...
var ICONS = {
  add: async () => (await import("./add-DEIHZ4HG.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-LHWBBFYD.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-JY74VWIV.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-CQDNQAE6.js")).appStoreSvg,
  apple: async () => (await import("./apple-V6A3KWQ3.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-T3MADWUW.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-DNDMFBQM.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-Z6ASYBAI.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-G7EVICQ7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-3ILSFKD3.js")).bankSvg,
  browser: async () => (await import("./browser-XLOAMAOE.js")).browserSvg,
  card: async () => (await import("./card-U3NY7FAO.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-3ZPDWGWC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-NIB775VV.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-MHDADQCV.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-P3T747RV.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-GHC2QBL7.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-K2YMOCIV.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-WYK4X7TE.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-GYCGFSLC.js")).clockSvg,
  close: async () => (await import("./close-TQ6FNN3T.js")).closeSvg,
  compass: async () => (await import("./compass-Y4K6TBQ3.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-G5RMKY7U.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-EIR2JIRH.js")).copySvg,
  cursor: async () => (await import("./cursor-7P4S73RY.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-NWT2YF3W.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-ASWVDAHX.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-PVEGMXJY.js")).disconnectSvg,
  discord: async () => (await import("./discord-OTZQTMFQ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OTR2HCE3.js")).etherscanSvg,
  extension: async () => (await import("./extension-WN6K6NZI.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-OKUFLWF4.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HIG6LZMR.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-TFVGRKSA.js")).farcasterSvg,
  filters: async () => (await import("./filters-GHSAI4SZ.js")).filtersSvg,
  github: async () => (await import("./github-XRBPZVNF.js")).githubSvg,
  google: async () => (await import("./google-H7DJCHFD.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-2XHST3EB.js")).helpCircleSvg,
  image: async () => (await import("./image-BJCNNGBE.js")).imageSvg,
  id: async () => (await import("./id-FBJ57RFR.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-2UR7G6W7.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-N3I6L62B.js")).lightbulbSvg,
  mail: async () => (await import("./mail-R4IK2DOS.js")).mailSvg,
  mobile: async () => (await import("./mobile-DXOR3AR3.js")).mobileSvg,
  more: async () => (await import("./more-VEKHFM43.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-DKELDFSO.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-VDQC33ZH.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-FNLMN5YG.js")).offSvg,
  playStore: async () => (await import("./play-store-KGBTPTW2.js")).playStoreSvg,
  plus: async () => (await import("./plus-SRBGD664.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-FGFN5QII.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-EOPPHNXL.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-JHOHI4WC.js")).refreshSvg,
  search: async () => (await import("./search-DU2DVATT.js")).searchSvg,
  send: async () => (await import("./send-7OLMMGYT.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-STUW3OHI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-MMW4BFHL.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PBISHJ45.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-UPXSH4PT.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JE6DOTP7.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-EX2WJM3E.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-OI6PPXOW.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-SPDQLHDV.js")).twitchSvg,
  twitter: async () => (await import("./x-JVYC2CCC.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-IG5G5IRR.js")).twitterIconSvg,
  verify: async () => (await import("./verify-Z2NAKLVZ.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-5UHE6GKC.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-S3GEN5PO.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-K3GEUJJ4.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-K3GEUJJ4.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-K3GEUJJ4.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-YWLICMQY.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-GV6NWLLI.js")).warningCircleSvg,
  x: async () => (await import("./x-JVYC2CCC.js")).xSvg,
  info: async () => (await import("./info-DSSYW2QP.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-UVKBWVBU.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-S2BINU23.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ULSKZ2QC.js.map
